                            ...
                            <form action="{{ route('admin.kelas.update', $kelas->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama_kelas"
                                        ...
                                        value="{{ old('nama', $kelas->nama_kelas) }}" placeholder="Masukan Nama Kelas">
                                    @error('nama_kelas')
                                ...
                                <button type="submit" class="btn btn-sm btn-primary"><i class="fas fa-pen"></i> Update</button>
                                <a href="{{ route('admin.kelas.index') }}" class="btn btn-sm btn-secondary"><i class="fas fa-arrow-left"></i> Kembali</a>
                            </form>
                        </div>
                    </div>
                </div>
